...
/*
 * from https://github.com/linux-can/can-tests/blob/master/drv/canfdtest.c- Full-duplex test program (DUT and host part)
 * Abort added; removed user command line interaction
 *
 */
...
// Added by me
int containsByte(struct can_frame *frame, unsigned char byte) {
