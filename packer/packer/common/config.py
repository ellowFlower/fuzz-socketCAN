...
class PackerConfiguration:
    ...
    def __load_arguments(self):
        ...
        nyx_net_group.add_argument('--nyx_net_can', help='Fuzz CAN protocol', action='store_true', default=False)
        nyx_net_group.add_argument('--can_spec_test_mode', help='Test CAN input specification', action='store_true', default=False)
