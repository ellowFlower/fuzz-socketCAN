...
def compile(config):
    ...
    CAN_MODE = config.argument_values["nyx_net_can"]
    CAN_SPEC_TEST_MODE = config.argument_values["can_spec_test_mode"]
    ...
    if CAN_MODE:
        os.environ["CAN_MODE"] = "-DCAN_MODE "
    if CAN_SPEC_TEST_MODE:
        os.environ["CAN_SPEC_TEST_MODE"] = "-DCAN_SPEC_TEST_MODE "
    if CLIENT_MODE:
